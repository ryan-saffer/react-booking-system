...
const SignatureDialog = (props) => {
    ...
    const handleSignOut = () => {
        if (selectedGuardian === '') {
            ...
            props.onSignOut(selectedGuardian, sigPad.getTrimmedCanvas().toDataURL('image/png'))
        }
    }
    ...
    return (
        <Dialog fullWidth={true} maxWidth={'xl'} open={props.open} disableBackdropClick={true}>
            ...
            <DialogContent className={classes.dialogContent}>
                ...
                {signatureError && (
                    <DialogContentText className={classes.error}>
                        A signature is required to sign out of science club
                    </DialogContentText>
                )}
            </DialogContent>
