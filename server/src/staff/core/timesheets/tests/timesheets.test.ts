...
describe('Timesheet suite', () => {
    ...
    describe('Pay Item mappings', () => {
        ...
        it('should map CGS overtime first three hours - mon to sat', () => {
            ...
            const scenarios = [
                { location: Studio.BALWYN, expected: 'CGS OT - First 3 Hrs - Mon to Sat - Balwyn' },
                { location: Studio.CHELTENHAM, expected: 'CGS OT - First 3 Hrs - Mon to Sat - Cheltenham' },
                { location: Studio.ESSENDON, expected: 'CGS OT - First 3 Hrs - Mon to Sat - Essendon' },
                { location: Studio.KINGSVILLE, expected: 'CGS OT - First 3 Hrs - Mon to Sat - Kingsville' },
                { location: Studio.MALVERN, expected: 'CGS OT - First 3 Hrs - Mon to Sat - Malvern' },
                { location: Studio.HEAD_OFFICE, expected: 'CGS OT - First 3 Hrs - Mon to Sat - Head Office' },
            ]
        ...
        it('should map CGS overtime first three hours - sunday', () => {
            ...
            const scenarios = [
                { location: Studio.BALWYN, expected: 'CGS OT - First 3 Hrs - Sunday - Balwyn' },
                { location: Studio.CHELTENHAM, expected: 'CGS OT - First 3 Hrs - Sunday - Cheltenham' },
                { location: Studio.ESSENDON, expected: 'CGS OT - First 3 Hrs - Sunday - Essendon' },
                { location: Studio.KINGSVILLE, expected: 'CGS OT - First 3 Hrs - Sunday - Kingsville' },
                { location: Studio.MALVERN, expected: 'CGS OT - First 3 Hrs - Sunday - Malvern' },
                { location: Studio.HEAD_OFFICE, expected: 'CGS OT - First 3 Hrs - Sunday - Head Office' },
            ]
        ...
        it('should map CGS overtime after three hours', () => {
            ...
            const scenarios = [
                { location: Studio.BALWYN, expected: 'CGS OT - After 3 Hrs - Balwyn' },
                { location: Studio.CHELTENHAM, expected: 'CGS OT - After 3 Hrs - Cheltenham' },
                { location: Studio.ESSENDON, expected: 'CGS OT - After 3 Hrs - Essendon' },
                { location: Studio.KINGSVILLE, expected: 'CGS OT - After 3 Hrs - Kingsville' },
                { location: Studio.MALVERN, expected: 'CGS OT - After 3 Hrs - Malvern' },
                { location: Studio.HEAD_OFFICE, expected: 'CGS OT - After 3 Hrs - Head Office' },
            ]
    ...
    describe('Guard clauses', () => {
        ...
        it('should throw on unrecognised location for ordinary pay items', () => {
            const invalidLocation = 'INVALID_LOCATION' as Studio
            const monday = DateTime.fromObject({ day: 1, month: 5, year: 2023 })
            const sunday = DateTime.fromObject({ day: 7, month: 5, year: 2023 })
