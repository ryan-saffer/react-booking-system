...
```text
apps/server/src/_scripts/.credentials/bookings-dev.json
apps/server/src/_scripts/.credentials/bookings-prod.json
```
...
```bash
export GOOGLE_APPLICATION_CREDENTIALS="$PWD/apps/server/src/_scripts/.credentials/bookings-dev.json"
...
```bash
export GOOGLE_APPLICATION_CREDENTIALS="$PWD/apps/server/src/_scripts/.credentials/bookings-prod.json"
