...
import { useConfirmWithCheckbox } from '@shared/components/dialogs/confirmation-with-checkbox/use-confirmation-dialog-with-checkbox'
...
import useErrorDialog from '@shared/components/dialogs/use-error-dialog'
