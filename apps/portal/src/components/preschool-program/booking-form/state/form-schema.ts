...
export type PreschoolProgramForm = z.infer<typeof formSchema>

export const defaultValues: DefaultValues<PreschoolProgramForm> = {
    parentFirstName: '',
    parentLastName: '',
    parentEmailAddress: '',
    parentPhone: '',
...
export function usePreschoolProgramForm() {
    return useFormContext<PreschoolProgramForm>()
}
