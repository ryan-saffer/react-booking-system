...
const GOOGLE_REVIEWS_API_URL = 'https://bookings.fizzkidz.com.au/api/reviews/google'
...
export async function getGoogleReviews(input: GetGoogleReviewsInput = 12) {
    try {
        ...
        const timeout = setTimeout(() => controller.abort(), GOOGLE_REVIEWS_FETCH_TIMEOUT_MS)
