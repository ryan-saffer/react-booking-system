    ...
    <SelectPrimitive.Root open={isOpen} onOpenChange={setIsOpen} {...props}>
      ...
      <FormControl>
        <SelectPrimitive.Trigger
          ...
          ref={ref}
          className={cn(
            "flex h-10 w-full items-center justify-between whitespace-nowrap rounded-xl border border-input border-violet-500 bg-transparent px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring focus-visible:outline-purple-700 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
          )}
        >
          {children}
          <SelectPrimitive.Icon asChild>
