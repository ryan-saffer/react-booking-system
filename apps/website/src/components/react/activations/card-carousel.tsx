...
function CardCarousel({ items, image1, image2, image3, image4, image5, image6 }: Props) {
    ...
    return (
        <Carousel className="mx-12 my-4">
            <CarouselContent className="my-4">
                {items.map((item) => (
                    <CarouselItem key={item.imageSlot} className="basis-full sm:basis-1/2 md:basis-1/3">
