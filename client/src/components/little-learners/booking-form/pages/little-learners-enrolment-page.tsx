...
import { LittleLearnersDetailsForm } from '../components/little-learners-details-form'
...
import type { LittleLearnersForm } from '../state/form-schema'
...
export function LittleLearnersEnrolmentPage() {
    const trpc = useTRPC()
    ...
    const form = useForm<LittleLearnersForm>({
    ...
    return (
        <Root logoSize="sm">
            <div className="w-full">
                <h1 className="text-center text-2xl">Little Learners Enrolment Form</h1>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                        {formStage === 'success' ? (
                            ...
                            <>
                                ...
                                {loadingClasses ? (
                                    ...
                                    <Alert variant="destructive">
                                        ...
                                        <AlertDescription>
                                            There was a problem checking the Little Learners sessions.
                                        </AlertDescription>
                                    </Alert>
                                    ...
                                    <LittleLearnersDetailsForm submitting={submitting} />
                                ) : null}
                            </>
                        ) : loadingPrograms ? (
                            <Loader />
                            ...
                            <Alert>
                                ...
                                <AlertDescription>
                                    There are no Little Learners programs available to book at the moment.
                                </AlertDescription>
                            </Alert>
                        )}
                    </form>
