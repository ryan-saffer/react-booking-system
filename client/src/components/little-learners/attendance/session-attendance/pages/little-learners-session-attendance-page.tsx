...
export function LittleLearnersSessionAttendancePage() {
    const trpc = useTRPC()
    ...
    const enrolmentsMap = useMemo(
        () =>
            enrolments.reduce<Record<string, LittleLearnersAttendanceEnrolment>>(
    ...
    if (!params) {
        return <Navigate to="/dashboard/little-learners" />
    }
            ...
            <div className="twp m-4 flex h-[calc(100vh-64px)] flex-col items-center justify-center">
                <Alert variant="destructive" className="w-full max-w-md">
                    ...
                    <AlertDescription className="text-center">
                        We couldn't load the Little Learners attendance data.
                    </AlertDescription>
                </Alert>
                <Button
                    variant="outline"
    ...
    if (rows.length === 0) {
        return (
            <div className="twp m-4 flex h-[calc(100vh-64px)] flex-col items-center justify-center">
                ...
                <Button variant="outline" className="mt-4" onClick={() => navigate('/dashboard/little-learners')}>
