                    ...
                    <Fragment key={child.id}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <SelectForm
                                        label={` Does ${form.watch('main.children')[idx].firstName || 'this child'} have any
                                        allergies?`}
                                        onValueChange={(value) => {
                                            if (value === 'yes') {
                                                field.onChange(true)
                        ...
                        {form.watch('main.children')[idx].hasAllergies && (
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <SelectForm
                                            label={`Is ${form.watch('main.children')[idx].firstName || 'this child'} anaphylactic?`}
                                            onValueChange={(value) => {
                                                if (value === 'yes') {
                                                    field.onChange(true)
                                                }
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <SelectForm
                                        label={`Does ${form.watch('main.children')[idx].firstName || 'your child'} need extra support for learning difficulties, disabilites or additional learning needs?`}
                                        onValueChange={(value) => {
                                            if (value === 'yes') {
                                                field.onChange(true)
                                            }
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <SelectForm
                                        label={`We love to show other parents the cool things that we do by taking pictures and videos. Do you give permission for ${form.watch('main.children')[idx].firstName || 'your child'} to be in our marketing content?`}
                                        onValueChange={(value) => {
                                            if (value === 'yes') {
                                                field.onChange(true)
                                            }
