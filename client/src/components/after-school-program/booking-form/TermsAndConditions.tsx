    ...
    return (
        <>
            ...
            <p>
                ...
                [insert link]. It is important that you familiarise yourself with the Program's activities.
            </p>
            <p>
            ...
            <p>
                2.2. You understand that Fizz Kidz is not the owner of the venue stated in the enrolment form at which
                the Program is operated and as such we make no representations or warranties about the venue.{' '}
            </p>
            <p>
                2.3. Where we choose to accept the enrolment of the enrolled child in the Program we do so in reliance
                on the above representations.
            </p>
            <p>
                <strong>3. Medical and related issues</strong>
            </p>
            <p>3.1. You authorise Fizz Kidz and our personnel and representatives: </p>
            <p>
                3.1.1. to consult with the enrolled child's school regarding any behavioural or medical management
                issues necessary to provide consistency and to otherwise enhance the service provided to the enrolled
                child;
            </p>
            <p>
            ...
            <p>3.1.3. to apply sunscreen to the enrolled child (if considered appropriate). </p>
            <p>
            ...
            <p>
                ...
                enrolled child is suffering from an infectious or contagious disease as identified by the Department of
                Health or in the opinion of our staff is too unwell to attend the Program.
            </p>
            <p>
            ...
            <p>
                4.3. If the enrolled child is subject to suspension or exclusion from the Program or is withdrawn from
                the Program due to medical reasons, Fizz Kidz may disclose the enrolled child's name and reasons for the
                suspension or exclusion, or medical conditions, to persons in control of the school or other venue at
            ...
            <p>
                You understand that the enrolled child will be under the direction and control of our staff. Further, if
                the enrolled child demonstrates unacceptable behaviour, you will be notified by staff and may be
                required to collect the enrolled child. In such circumstances, you agree to immediately make
            ...
            <p>
                ...
                they arrive from their school activities to our care. Further, the enrolled child is no longer under our
                supervision or care once they are signed out.
            </p>
            <p>
            ...
            <p>
                <strong>8. Exclusion of our liability</strong>
            </p>
            <p>
                8.1. You acknowledge and agree Fizz Kidz does not accept any liability for personal injury, property
                damage or loss sustained by the enrolled child or their parent or guardian due to them participating in
                the Program other than to the extent that the injury, damage or loss was caused or contributed to by the
                proven negligence of Fizz Kidz its directors, officers, employees or contractors, except as otherwise
                expressly required by law.
            </p>
            <p>
                8.2. You must indemnify Fizz Kidz and our directors, officers, employees and contractors (collectively
            ...
            <p>
                <strong>9. Cancellation procedures</strong>
            </p>
            <p>
            ...
            <p>
                <strong>10. Consequences of non-payment</strong>
            </p>
            <p>
            ...
            <p>
                <strong>11. Amendments to these terms</strong>
            </p>
            <p>
