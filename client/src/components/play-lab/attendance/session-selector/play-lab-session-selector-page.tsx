...
export function PlayLabSessionSelectorPage() {
    ...
    const [selectedCalendar, setSelectedCalendar] = useState<string | null>(
        currentOrg === 'master' ? null : AcuityConstants.StoreCalendars[currentOrg!].toString()
    )
    ...
    useEffect(() => {
        setSelectedCalendar(currentOrg === 'master' ? null : AcuityConstants.StoreCalendars[currentOrg!].toString())
    }, [currentOrg])
