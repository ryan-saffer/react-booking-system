...
const programs: NavigationItem[] = [
    ...
    },
    {
        ...
        description: 'Manage staff attendance for our new term-based pre-school program',
        to: 'little-learners',
        imgSrc: kingsville,
        accent: '#9ecc48',
...
const adminItems: NavigationItem[] = [
    ...
    {
        title: 'Little Learners Invoicing',
        description: 'Send invoices and track payment status for Little Learners enrolments.',
        to: 'little-learners-invoicing',
